<script>
var defaultKriteria = <?php echo json_encode($default_kriteria); ?>;
</script>
        ...
        <div class="card p-3">
            ...
            <form id="formKriteria">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control form-control-sm" id="N_kriteria" readonly>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="colFormLabelSm" class="col-sm-2 col-form-label col-form-label-sm">Nilai Bobot
                        Preferensi</label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control form-control-sm" id="P_kriteria" readonly>
                    </div>
                </div>
